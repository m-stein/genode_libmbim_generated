 ...
 * @out_entries: (out)(optional)(transfer full)(array zero-terminated=1)(element-type MbimPhonebookEntry): return location for a newly allocated array of #MbimPhonebookEntrys, or %NULL if the 'Entries' field is not needed. Free the returned value with mbim_phonebook_entry_array_free().
 * @error: return location for error or %NULL.
 *
