 ...
 * @out_providers: (out)(optional)(transfer full)(array zero-terminated=1)(element-type MbimAtdsProvider): return location for a newly allocated array of #MbimAtdsProviders, or %NULL if the 'Providers' field is not needed. Free the returned value with mbim_atds_provider_array_free().
 * @error: return location for error or %NULL.
 *
